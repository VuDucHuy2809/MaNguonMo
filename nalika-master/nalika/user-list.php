                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                echo "<tr>
                                    ...
                                    <td>".$value->phone."</td>
                                    <td>
                                        <a href='user-edit.php?id=".$value->user_id."'><button data-toggle='tooltip' title='Edit' class='pd-setting-ed'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></button></a>";
