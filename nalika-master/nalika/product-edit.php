                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form method='get' action='product-update.php'>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <?php
                                                        echo "<input name='name' type='text' class='form-control' value='".$products->name."' placeholder='Product Name'>";
                                                        ?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                        <?php
                                                        echo "<input name='status' type='text' class='form-control' value=".$products->status." placeholder='Status'>";
                                                        ?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <?php
                                                        echo "<input name='price' type='text' class='form-control' value=".$products->price." placeholder='Regular Price'>";
                                                        ?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                        <?php
                                                        echo "<input name='quantity' type='text' class='form-control' value=".$products->quantity." placeholder='Quantity'>";
                                                        ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <?php
                                                       echo "<input name='description' type='text' class='form-control' value='a' placeholder='Description'>";
                                                        ?>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
